...
#  MA  02110-1301, USA.
'''
Essa é uma versão modificada do motion_commander, do cflib. Algumas modificações importantes é o safeSleep, que realiza o time.sleep com segurança, permitindo realizar pouso de emergencia; e o parametro _stopMotion, que ordena um pouso de emergencia. Substituir no cflib->positioning->motion_commander.py
